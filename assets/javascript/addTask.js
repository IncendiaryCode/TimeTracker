...
$(document).ready(function() {
			...
			if (sameName == 0) {
				$.ajax({
			        ...
			        success: function(res) {
			        	...
			        	i++;
			            var element = $('<select class="form-control mt-3"  id="user-name'+i+'" name="user_name'+i+'"><option>Select User</option>');
	...
	$("select.chooseProject").change(function() {
