...
<body >
        ...
        <div id="form2" class="animated fadeInRightBig">
            <form id="forgotPassword" novalidate method="post" class="login-form" action="<?=BASE_URL?>php/check_otp.php" onsubmit="validateOtp()">
                ...
                <div class="form-group otp">
                  ...
                  <div class="row top-space " style="width: 100%;">
                    <a href="<?=BASE_URL?>index.php" class="col-6 forgot-color"><i class="fas fa-arrow-left"> back to login</i></a>
                    <button class="btn btn-primary col-3 login-color offset-3" id="count" type="submit">  Submit  </button>    
                </div>
       ...
       <div id="formPsw" class="animated fadeInRightBig">
            <form id="reEnterPsw" novalidate method="post" class="login-form" action="">
                    <div class=" logo-space">
