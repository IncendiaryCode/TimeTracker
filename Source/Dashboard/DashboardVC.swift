...
, FilterToday {
    ...
    override func viewDidLoad() {
        ...
        //Register Nib.
        tblUserDetails.register(UINib(nibName: "TaskInfoCell", bundle: nil),
...
//                }
    ...
    func startOrStopTask(indexPath: IndexPath?) {
        ...
        if let indxPath = indexPath {
            ...
            let cell = tblUserDetails.cellForRow(at: indxPath) as! TaskDetailsCell
...
//                    , animated: true)
            ...
            if btnState.currentTitle == "Stop" && arrRunningTask.count > 0 {
                ...
                let cTaskDetails = arrCTaskDetails[indexPath.row]
                let pageNo = cTaskDetails.pageNo
                if let cell = tblUserDetails.cellForRow(at: indexPath) as? TaskDetailsCell {
