...
class DateCollectionViewCell: UICollectionViewCell {
    ...
    let uiColor = UIColor(red: 140/255, green: 109/255, blue: 252/255, alpha: 1.0)
    ...
    override var isSelected: Bool {
        didSet {
            ...
            contentView.backgroundColor = isSelected == true ? uiColor : .white
