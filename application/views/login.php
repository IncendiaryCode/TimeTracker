...
<body>
   ...
   <!--     <div id="form2" class="animated fadeInRightBig">
            <form id="forgotPassword" method="post" class="login-form" action="../php/check_otp.php" onsubmit="validateOtp()" novalidate>
                    ...
                    <div class="form-group otp">
                      ...
                      <div class="row top-space" style="width: 100%;">
                        <a href="../index.php" class="col-6 text-left forgot-color"><i class="fas fa-arrow-left"> back to login</i></a>
        ...
        <div id="formPsw" class="animated fadeInRightBig">
            <form id="reEnterPsw" method="post" class="login-form" action="../php/change_pwd.php" novalidate>
